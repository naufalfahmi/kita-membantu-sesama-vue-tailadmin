...
const canCreate = computed(() => hasPermission('create jabatan'))
const canUpdate = computed(() => hasPermission('update jabatan'))
const canDelete = computed(() => hasPermission('delete jabatan'))
