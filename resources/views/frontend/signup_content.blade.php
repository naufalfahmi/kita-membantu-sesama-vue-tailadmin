    ...
    <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
      <!-- Bg Shapes -->
      <img src="{{ asset("frontend/images/shape-06.svg") }}" alt="Shape" class="h j k" />
      <img src="{{ asset("frontend/images/shape-03.svg") }}" alt="Shape" class="h l m" />
      <img src="{{ asset("frontend/images/shape-17.svg") }}" alt="Shape" class="h n o" />
      <img src="{{ asset("frontend/images/shape-18.svg") }}" alt="Shape" class="h p q" />
      ...
      <div class="animate_top bb af i va sg hh sm vk xm yi _n jp hi ao kp">
        ...
        <form class="sb" action="#!" method="#!">
          ...
          <p class="sj hk xj rj ob">
            ...
            <a class="mk" href="{{ route("frontend.signin") }}"> Sign In </a>
          </p>
        </form>
      </div>
    </section>
