...
const canCreate = computed(() => hasPermission('create donatur'))
const canUpdate = computed(() => hasPermission('update donatur'))
const canDelete = computed(() => hasPermission('delete donatur'))
