...
<footer>
  <div class="bb ze ki xn 2xl:ud-px-0">
      ...
      <div class="tc uf ap gg fp">
        <div class="animate_top zd/2 to/4">
          <a href="{{ route('frontend.index') }}">
            <img src="{{ asset('frontend/images/logo-light.svg') }}" alt="Logo" class="om" />
            <img src="{{ asset('frontend/images/logo-dark.svg') }}" alt="Logo" class="xc nm" />
          </a>
    ...
    <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
      ...
      <div class="animate_top">
        <p>&copy; {{ date('Y') }} {{ config('app.name', 'KMS') }}. All rights reserved.</p>
      </div>
    </div>
    <!-- Footer Bottom -->
  </div>
