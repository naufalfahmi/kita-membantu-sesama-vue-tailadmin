  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="{{ route('frontend.index') }}">
        <img class="om" src="{{ asset('frontend/images/logo-light.svg') }}" alt="Logo Light" />
        <img class="xc nm" src="{{ asset('frontend/images/logo-dark.svg') }}" alt="Logo Dark" />
      </a>
    ...
    <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
      <nav>
        <ul class="tc _o sf yo cg ep">
          <li><a href="{{ route('frontend.index') }}" class="xl" :class="{ 'mk': page === 'home' }">Home</a></li>
          <li><a href="{{ route('frontend.index') }}#features" class="xl">Features</a></li>
          <li class="c i" x-data="{ dropdown: false }">
            ...
            <ul class="a" :class="{ 'tc': dropdown }">
              <li><a href="{{ route('frontend.blog-grid') }}" class="xl" :class="{ 'mk': page === 'blog-grid' }">Blog Grid</a></li>
              <li><a href="{{ route('frontend.blog-single') }}" class="xl" :class="{ 'mk': page === 'blog-single' }">Blog Single</a></li>
              <li><a href="{{ route('frontend.signin') }}" class="xl" :class="{ 'mk': page === 'signin' }">Sign In</a></li>
              <li><a href="{{ route('frontend.signup') }}" class="xl" :class="{ 'mk': page === 'signup' }">Sign Up</a></li>
              <li><a href="{{ route('frontend.404') }}" class="xl" :class="{ 'mk': page === '404' }">404</a></li>
            </ul>
            <!-- Dropdown End -->
          </li>
          <li><a href="{{ route('frontend.index') }}#support" class="xl">Support</a></li>
        </ul>
      </nav>
      ...
      <div class="tc wf ig pb no">
        ...
        <a href="{{ route('frontend.signin') }}" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }"
          class="ek pk xl">Sign In</a>
        <a href="{{ route('frontend.signup') }}" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }"
