...
const rowDataArray = [
  {
    id: '1',
    nama: 'PT Dermawan Sejati',
    noInduk: 'D001',
    pic: 'Ahmad Hidayat',
    tipeDonatur: 'Donatur Tetap',
    status: 'Aktif',
    tanggal: '2024-01-15',
  },
  {
    id: '2',
    nama: 'CV Peduli Bangsa',
    noInduk: 'D002',
    pic: 'Siti Nurhaliza',
    tipeDonatur: 'Donatur Bulanan',
    status: 'Aktif',
    tanggal: '2024-02-20',
  },
  {
    id: '3',
    nama: 'Yayasan Berbagi Kasih',
    noInduk: 'D003',
    pic: 'Budi Santoso',
    tipeDonatur: 'Donatur Rutin',
    status: 'Aktif',
    tanggal: '2024-03-10',
  },
  {
    id: '4',
    nama: 'PT Bantuan Sosial',
    noInduk: 'D004',
    pic: 'Dewi Lestari',
    tipeDonatur: 'Donatur Insidental',
    status: 'Tidak Aktif',
    tanggal: '2024-04-05',
  },
  {
    id: '5',
    nama: 'UD Sukarela Jaya',
    noInduk: 'D005',
    pic: 'Eko Prasetyo',
    tipeDonatur: 'Donatur Korporasi',
    status: 'Aktif',
    tanggal: '2024-05-12',
  },
  {
  ...
  },
  {
    ...
    noInduk: 'D007',
    pic: 'Guntur Wibowo',
    tipeDonatur: 'Donatur Organisasi',
    status: 'Aktif',
    tanggal: '2024-07-25',
  },
  {
...
const handleDelete = (id: string) => {
  console.log('Delete donatur:', id)
  if (confirm('Apakah Anda yakin ingin menghapus donatur ini?')) {
    alert(`Donatur dengan ID: ${id} akan dihapus`)
  }
}
