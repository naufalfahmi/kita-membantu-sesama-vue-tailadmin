            ...
            <div class="lg:col-span-1">
              ...
              <div class="relative z-20 bg-transparent">
                <select
                  ...
                  :class="{ 'text-gray-800 dark:text-white/90': formData.tipe_pembagian_marketing }"
                >
                  <option value="" disabled selected>Pilih Tipe Pembagian</option>
                  <option value="percentage" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                    Persentase
                  </option>
                  <option value="nominal" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                    Nominal
                  </option>
                </select>
                <span
